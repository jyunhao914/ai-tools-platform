...
const state = {
  ...
  fields: [
    makeField({ id:'f_org',   label:'單位', kind:'text', template:'{單位}',
                size:12, x:8,   y:12,  align:'left',   weight:400, lineHeight:1.3 }),
    makeField({ id:'f_name',  label:'姓名', kind:'text', template:'{姓名}',
                size:36, x:74,  y:33,  align:'center', weight:700,
                letterSpacing:0.05, lineHeight:1.15, autoFit:true }),
    makeField({ id:'f_title', label:'職稱', kind:'text', template:'{職稱}',
                size:14, x:140, y:48,  align:'right',  weight:400, lineHeight:1.3 })
  ],
